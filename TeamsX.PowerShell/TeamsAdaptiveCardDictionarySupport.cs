...
internal static class TeamsAdaptiveCardDictionarySupport {
    internal static Dictionary<string, object?> ToDictionary(TeamsAdaptiveCard card) {
    ...
    internal static Dictionary<string, object?>? BuildBackgroundImage(
        string? backgroundUrl,
        string? backgroundFillMode,
        string? backgroundHorizontalAlignment,
        string? backgroundVerticalAlignment) {
    ...
    private static Dictionary<string, object?> RenderAdaptiveElement(TeamsAdaptiveCardElement element) {
        ...
        throw new NotSupportedException($"Adaptive element '{element.GetType().Name}' is not supported by the PowerShell show-card renderer yet.");
    }
    ...
    private static Dictionary<string, object?> RenderAdaptiveAction(TeamsAdaptiveAction action) {
        ...
        throw new NotSupportedException($"Adaptive action '{action.GetType().Name}' is not supported by the PowerShell show-card renderer yet.");
    }
