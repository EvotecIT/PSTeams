...
### __AllParameterSets
```powershell
Add-SlackReaction [-Reference] <MessageReference> [-Reaction] <string> -Connection <SlackConnection> [-PassThru] [-Proxy <uri>] [-TimeoutSeconds <int>] [-UserAgent <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
