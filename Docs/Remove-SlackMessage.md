...
### __AllParameterSets
```powershell
Remove-SlackMessage [-Reference] <MessageReference> -Connection <SlackConnection> [-PassThru] [-Proxy <uri>] [-TimeoutSeconds <int>] [-UserAgent <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
