...
### __AllParameterSets
```powershell
Remove-DiscordReaction [-Reference] <MessageReference> [-Reaction] <string> -Connection <DiscordConnection> [-PassThru] [-Proxy <uri>] [-TimeoutSeconds <int>] [-UserAgent <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
