...
### __AllParameterSets
```powershell
New-AdaptiveColumnSet [[-Columns] <scriptblock>] [-Style <string>] [-MinimumHeight <int>] [-Bleed] [-Spacing <string>] [-Separator] [-HorizontalAlignment <string>] [-Height <string>] [<CommonParameters>]
```
