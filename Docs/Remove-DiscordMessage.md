...
### Bot (Default)
```powershell
Remove-DiscordMessage [-Reference] <MessageReference> -Connection <DiscordConnection> [-PassThru] [-Proxy <uri>] [-TimeoutSeconds <int>] [-UserAgent <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Webhook
```powershell
Remove-DiscordMessage [-Reference] <MessageReference> -WebhookTarget <DiscordMessageTarget> [-PassThru] [-Proxy <uri>] [-TimeoutSeconds <int>] [-UserAgent <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
